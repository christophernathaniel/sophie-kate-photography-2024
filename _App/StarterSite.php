...
class StarterSite extends Site
{
	...
	public function add_to_context($context)
	{
		...
		$context['menu']  = Timber::get_menu('main_navigation');
		$context['site']  = $this;
		$context['thefields'] = get_fields();
	...
	public function add_to_twig($twig)
	{
		...
		// Define a custom Twig filter for base64 encoding
		$twig->addFilter(new Twig\TwigFilter('base64_encode', [$this, 'base64EncodeFilter']));
